          ...
          <Row className="text-center description-section">
            <Col>
              <p className="description-text">
                In today's fast-paced world, where time and money are precious,
                Palate-Pantry is here to help you save both. Our app streamlines
                meal planning and grocery shopping within your budget,
                empowering you to manage your culinary tasks effortlessly.
              </p>
              <p className="description-text-2">
                From Smart Meal Planning & Custom Shopping Lists to Integrated
