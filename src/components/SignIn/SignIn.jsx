  ...
  return (
    <div className='sign-in-page container-fluid p-0'>
      ...
      <div className='signin-form'>
        ...
        <div>
          <label htmlFor="username" style={{ color: 'black', fontSize: '18px' }}>Enter your username or email address</label><br />
          <input
            name='username'
            type="text"
        ...
        <div className="text-center mt-3" style={{ color: 'black', fontSize: '18px' }}>Or</div>
